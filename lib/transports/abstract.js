...
AbstractTransport.prototype.onData = function (callback) {
  var errorMsg = 'AbstractTransport.onData function not implemented'
  this._log.error(errorMsg)
  this._error(errorMsg)
}

AbstractTransport.prototype.onError = function (callback) {
  var errorMsg = 'AbstractTransport.onError function not implemented'
  this._log.error(errorMsg)
  this._error(errorMsg)
}
